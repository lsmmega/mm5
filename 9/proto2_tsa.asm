...
;attributes
	...
	.BYTE spikes << 4      | 1 ;03
	.BYTE spikes << 4      | 1 ;04
	.BYTE glide_left << 4  | 0 ;05
	.BYTE glide_left << 4  | 0 ;06
	.BYTE wall << 4        | 0 ;07
	.BYTE laddertop << 4   | 1 ;08
	.BYTE background << 4  | 1 ;09
	.BYTE background << 4  | 0 ;0A
	.BYTE spikes << 4      | 1 ;0B
	.BYTE background << 4  | 0 ;0C
	.BYTE glide_right << 4 | 0 ;0D
	.BYTE glide_right << 4 | 0 ;0E
	...
	.BYTE wall << 4        | 1 ;8E
	.BYTE wall << 4        | 1 ;8F
	.BYTE foreground << 4  | 0 ;90
	.BYTE foreground << 4  | 0 ;91
	.BYTE wall << 4        | 1 ;92
